    ...
    <div className='signupContainer'>
      <form className='form' onSubmit={state==="login"?login:signup}>
        <div className="mb-3">
            ...
            {state==="signup"?<input required type="text" className="input input-bordered w-full max-w-xs my-2 h-12" name='name'  placeholder="Enter name"  onChange={onchangeHandler} value={credentials.name} />:<></>}
            <input required type="text" className="input input-bordered w-full max-w-xs my-2 h-12" name='username' min={3} placeholder="Enter username" onChange={onchangeHandler} value={credentials.username}/>
