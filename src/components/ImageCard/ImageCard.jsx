...
const ImageCard = (props) => {
  ...
  const { all_images, favorite_images, HOST, imageData, setShowModal } = context;
  ...
  const handleImageClick = () => {
    setImages([props]); // Ensure only the clicked image is set
    setShowModal(true);
  };
    ...
    <>
      <div className="imageContainer">
        <div className="Images">
          <img src={props.source} onClick={handleImageClick} className="personal_images" alt="" />
          <div className="image-icons">
            {location.pathname !== "/favorites" && (
              <img src={delete_icon} onClick={() => handleDeleteClick(props.id)} className="delete_icon" alt="Delete" />
            )}
